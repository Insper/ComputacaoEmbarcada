...
1. Abra o `lcd-image-converter` :arrow_right: `File` :arrow_right: `New image`
    - name: `lavagens`
...
1. `Solution Explorer` :arrow_right: `Botão Direito` em `src` :arrow_right: `Add` :arrow_right: `New Folder`
    - Nome: `icones`
